...
// At the end of taskmanager_model.dart
...
class Task {
  ...
  final String? recurringGroupId; // All instances share this ID
  final RecurrenceFrequency recurrenceFrequency;
  final DateTime? recurringStartDate; // First class date
  final DateTime? recurringEndDate; // Last class date
  final int recurringInstanceIndex; // Which instance in the series (0, 1, 2, ...)
  ...
  // lib/models/taskmanager_model.dart - Fix the constructor with default values
  ...
  Task({
    ...
    this.isDone = false,
    this.completedAt,
    // Recurring fields - ✅ Add default values
    this.recurringGroupId,
    this.recurrenceFrequency = RecurrenceFrequency.none, // ✅ Default value
    this.recurringStartDate,
    this.recurringEndDate,
    this.recurringInstanceIndex = 0, // ✅ Default value
    this.isRecurringParent = false, // ✅ Default value
    // Auto-completion fields - ✅ Add default values
    this.autoCompleted = false, // ✅ Default value
    this.autoCompletedAt,
    this.autoCompletionSource,
    this.extensionHistory,
    this.totalExtensions = 0, // ✅ Default value
    this.countedInStats = false, // ✅ Default value
  ...
  // ✅ Get the next class date in the series
  ...
  // ✅ Get the previous class date in the series
